...
public class ArchivoCrud {

    public int numColumna(LeerFichero aq, Object modelo){
    ...
    public Object[][] agregarContenido(LeerFichero aq, Object modelo){
    ...
    public Object[][] editarRegistro(LeerFichero aq, int numIdColumModelo, String dato, Object modelo){
        Object[][] datosAnt=listarContenido(aq);
        Field[] fields = (modelo).getClass().getDeclaredFields();
    ...
    public Object[][] eliminarRegistros(LeerFichero aq, int numIdColumModelo, String dato){
        Object[][] datosAnt=listarContenido(aq);
    ...
    public Object[][] listarContenido(LeerFichero aq){
            Object[][] datos=null;		
            List<String> lista2 = new ArrayList();                
                    try {                  
                        lista2=aq.leer();
    ...
    public Object[][] buscarContenido(LeerFichero aq, int numColumna, String dato){
            Object[][] datos=null;	
            List<String> lista2 = new ArrayList();                
                    try {                  
                        lista2=aq.leer();
